...
export default class extends Controller {
  static targets = ["password", "eyeIcon", "eyeSlashIcon", "email", "emailError", "passwordError", "submitButton"]
  ...
  setupValidation() {
    try {
      ...
      if (this.hasEmailTarget) {
        ...
        this.emailTarget.addEventListener('input', () => this.clearEmailError())
      }
      
      if (this.hasPasswordTarget) {
        this.passwordTarget.addEventListener('blur', () => this.validatePassword())
        this.passwordTarget.addEventListener('input', () => this.clearPasswordError())
      }
    } catch (error) {
